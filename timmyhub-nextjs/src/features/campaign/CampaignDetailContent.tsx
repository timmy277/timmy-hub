                    ...
                    >
                        ...
                        >
                            <Group justify="space-between" w="100%" align="flex-end">
                                ...
                                {timerDisplay && (
                                    <Paper p="md" radius="md" bg="rgba(0,0,0,0.6)">
                                        <Stack gap={4} align="center">
                                            <Group gap="xs">
                                                <Iconify icon="tabler:clock" width={20} color="white" />
                                                <Text c="white" fw={600}>Kết thúc sau</Text>
                                            </Group>
                                            <Text size="xl" fw={700} c="white" style={{ fontFamily: 'monospace', fontSize: 24 }}>
                                                {timerDisplay}
                                            </Text>
                                        </Stack>
                                    </Paper>
                    ...
                    >
                        <Group justify="space-between" align="flex-end">
                            <Group gap="lg" align="flex-end">
                                <Text size="xl" fw={700} c={config.titleColor} style={{ fontSize: 48, lineHeight: 1 }}>
                                    {config.icon}
                                </Text>
                                <Box>
                                    <Group gap="sm" mb="xs">
                            ...
                            {timerDisplay && (
                                <Paper p="md" radius="md" bg="rgba(255,255,255,0.2)">
                                    <Stack gap={4} align="center">
                                        ...
                                        <Text size="xl" fw={700} c={config.titleColor} style={{ fontFamily: 'monospace', fontSize: 24 }}>
                                            {timerDisplay}
                                        </Text>
                                    </Stack>
                                </Paper>

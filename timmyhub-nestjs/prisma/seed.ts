...
import { seedingPublicVouchersData } from './seeds/voucher';
import { seedingPostsData } from './seeds/post';
...
async function seed() {
    ...
    // 7. Seed Vouchers
    await seedingPublicVouchersData(prisma);

    // 8. Seed Posts
    await seedingPostsData(prisma);
